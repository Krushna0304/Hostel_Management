...
function AuthLayout({ title, subtitle, children, footer }) {
  return (
    <div className="min-h-screen bg-[radial-gradient(circle_at_top_left,_rgba(14,165,233,0.14),_transparent_30%),radial-gradient(circle_at_bottom_right,_rgba(15,23,42,0.08),_transparent_35%),linear-gradient(180deg,#f8fafc_0%,#eef2ff_100%)]">
      <div className="mx-auto grid min-h-screen max-w-7xl items-center gap-10 px-4 py-8 lg:grid-cols-[1.1fr_0.9fr] lg:px-8">
        <div className="hidden rounded-[2rem] border border-white/70 bg-slate-950 p-10 text-white shadow-[0_40px_120px_-60px_rgba(15,23,42,0.8)] lg:block">
        ...
        <div className="mx-auto w-full max-w-xl">
          <div className="rounded-[2rem] border border-white/80 bg-white/90 p-6 shadow-[0_30px_90px_-50px_rgba(15,23,42,0.45)] backdrop-blur sm:p-8">
